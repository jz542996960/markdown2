...
public class DateUtil {
    public enum DateStyle {
        ...
        YYMM("yyMM", false), YYMMDD("yyMMdd", false), YYMMDDHHMM("yyMMddHHmm", false), YYMMDDHHMMSS("yyMMddHHmmss",
                false),

        YYYYMM("yyyyMM", false), YYYYMMDD("yyyyMMdd", false), YYYYMMDDHHMM("yyyyMMddHHmm",
                false), YYYYMMDDHHMMSS("yyyyMMddHHmmss", false),
...
//
//
//        Date dates = DateUtil.stringToDate("20181226030000");
//
//        Date date = new Date();
//        String nowDate = DateUtil.dateToString(dates, DateStyle.YYYYMMDDHHMMSS);
//        //获取七天前的时间
//        String startDate = DateUtil.addDay(nowDate,-7);
//        System.out.println(Long.parseLong(startDate));
//
//
//    }
    ...
    public static DateStyle getDateStyle(String date) {
        ...
        for (DateStyle style : DateStyle.values()) {
            ...
            if (date != null) {
                try {
                    if(style.getValue().length() != date.length()){
                        continue;
                    }
    ...
    public static void main(String[] args) {
        System.out.println(stringToString("20180919112910",DateStyle.YYYY_MM_DD_HH_MM_CN));
    }
    ...
    /**
     * 将日期转化为日期字符串。(yyyy-MM-dd 上午/下午),大于12点返回下午,否则上午 失败返回null。
     *
     * @param date
     * @return
     */
